...
void addDataToFirestore() async {
  ...
  List<Map<String, dynamic>> dataList = [
    ...
    },
    {
      ...
      "price": 999.99,
      "description":
          "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration provides stunningly realistic and accurate color and contrast 144HZ HIGH REFRESH RATE and 1ms ultra fast response time lets you enjoy the smoothest gaming experience ever CHAMPION LEVEL ADAPTIVE SYNC technology minimizes input lag, screen tearing and stutter, ensuring a fluid gaming session every time",
      "category": "electronics",
    ...
    },
    {
      ...
      "price": 56.99,
      "description":
          "Note:The Jackets is US standard size, Please choose size as your usual wear Material: 100% Polyester; Detachable Liner Fabric: Warm Fleece. Waterproof, Windproof, warm and breathable. Hooded Shell: Detachable storm hood, adjustable cuff, wear resisting soft shell is highly wind resistant.",
    ...
    },
    {
      ...
      "price": 29.95,
      "description":
          "100% POLYURETHANE (shell) 100% POLYESTER (liner) Imported Zipper closure Hand Wash Only PREMIUM FABRIC: Shell: 100% polyurethane. Lining: 100% polyester. 2 pockets with zippers. Removable hood. Adjustable belt.",
      "category": "women's clothing",
  ...
  for (Map<String, dynamic> data in dataList) {
    DocumentReference docRef = products.doc(data['id'].toString());
    DocumentSnapshot docSnap = await docRef.get();

    if (!docSnap.exists) {
      await docRef.set(data);
      print('Added product with id: ${data['id']}');
    } else {
      print('Product with id: ${data['id']} already exists');
    }
  }
...
void addOrdersToFirestore() async {
  ...
  for (var order in ordersList) {
    ...
    if (!doc.exists) {
      ...
      print("Order with id ${order['id']} already exists");
    }
  }
